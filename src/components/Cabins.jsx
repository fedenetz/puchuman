      ...
      <div className="cabins__grid">
        {CABINS.map((cabin, index) => <article className="cabin-card" key={cabin.name}>
          ...
          <div className="cabin-card__body">
            ...
            <div className="card-actions"><span className="booking-control"><button className="button button--disabled" disabled>Reservar</button><small>Próximamente</small></span><a className="text-link" href="#preguntas">Ver detalles <ArrowRight size={16} /></a></div>
          </div>
        </article>)}
      </div>
    </div>
